...
# Source: reference-rosa/terraform/master-chart/services/*/variables.tf
...
$ChartRegistry = [ordered]@{
    ...
    # Note: oetp_client chart does not exist in the registry (404) — likely bundled into oetp_server
}
